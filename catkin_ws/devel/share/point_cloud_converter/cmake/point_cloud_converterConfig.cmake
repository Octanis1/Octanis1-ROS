...
if("TRUE" STREQUAL "TRUE")
  set(point_cloud_converter_SOURCE_PREFIX /home/viki/Desktop/Octanis1-ROS/catkin_ws/src/point_cloud_converter)
  set(point_cloud_converter_DEVEL_PREFIX /home/viki/Desktop/Octanis1-ROS/catkin_ws/devel)
  ...
  set(point_cloud_converter_INSTALL_PREFIX /home/viki/Desktop/Octanis1-ROS/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'viki <viki@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'point_cloud_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/Desktop/Octanis1-ROS/catkin_ws/src/point_cloud_converter/${idir}'.  Ask the maintainer 'viki <viki@todo.todo>' to fix it.")
    endif()
